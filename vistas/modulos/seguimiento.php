...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Administrar Seguimiento Afiliados
            ...
            echo '<tr>
                  ...
                  $respuestalocalidad = ControladorClientes::ctrMostrarLocalidad($itemLocalidad, $valorLocalidad);
                    ...
                    <td> 
                      ...
                      <select class="form-control selectsUsuario"  name="selectAsignarUsuario" idCliente="'.$value["id"].'">
                            '; 
                            foreach ($usuarios as $llave => $valor) {
                              if ($valor["localidad"] == $value["localidad"])
                            echo'
                            <option value="'.$valor["id"].'"'; if ($valor["id"] == $value["asigusuario"]){echo'selected';} echo '>'.$valor["nombre"].'</option>
                             ';}
